        ...
        <div class="row gx-5">
            ...
            <div class="col-lg-7">
                <div class="border-start border-5 border-primary ps-5 mb-5">
                    <h6 class="text-primary text-uppercase"><a href="{{url ('views.interact.introduce')}}">Về chúng tôi</a></h6>
                    <h1 class="display-5 text-uppercase mb-0">
                        <b class="chopchop">PERFUME STORE</b> <br> 
                        <p style="padding: 30px">Hòa Mình Trong <br>Thế Giới Hương Thơm</p>
                    </h1>
                </div>
